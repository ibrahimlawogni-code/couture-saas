...
/* Un seul système de formes sur toute la page : boutons en rounded-xl,
   blocs et cartes en rounded-2xl, images en rounded-3xl. */
    ...
    <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/90 backdrop-blur">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/login"
            className="rounded-xl px-3 py-2 text-sm font-medium text-zinc-600 transition-colors hover:text-zinc-950"
          >
            Se connecter
          </Link>
          <Link
            href="/signup"
            className="rounded-xl bg-zinc-950 px-4 py-2.5 text-sm font-medium text-white transition-transform hover:bg-zinc-800 active:translate-y-px"
          >
...
function Hero() {
  return (
    <section className="mx-auto grid max-w-6xl items-center gap-12 px-5 pt-16 pb-20 lg:grid-cols-[1.1fr_0.9fr] lg:pt-24">
      <div>
        <h1 className="text-4xl font-semibold leading-[1.05] tracking-tight text-zinc-950 md:text-5xl lg:text-6xl">
          Votre atelier,
          <br />
          enfin sous contrôle.
        </h1>
        ...
        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/signup"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-4 text-base font-medium text-white transition-transform hover:bg-emerald-700 active:translate-y-px"
          >
            Essayer gratuitement
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-300 bg-white px-6 py-4 text-base font-medium text-zinc-900 transition-colors hover:bg-zinc-50 active:translate-y-px"
          >
      ...
      <div className="relative mx-auto w-full max-w-[280px] lg:max-w-[320px]">
        <div className="absolute -inset-6 -z-10 rounded-[3rem] bg-emerald-50" />
        <Image
...
function Fonctions() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-24">
      <h2 className="max-w-xl text-3xl font-semibold tracking-tight text-zinc-950 md:text-4xl">
        Tout ce que vous notiez sur papier, au même endroit
      </h2>

      <div className="mt-12 grid gap-5 md:grid-cols-3">
        <article className="md:col-span-2 overflow-hidden rounded-2xl border border-zinc-200 bg-white">
          <div className="p-8">
          ...
          <div className="ml-8 h-56 overflow-hidden rounded-tl-2xl border-l border-t border-zinc-200">
            <Image
              src="/captures/commandes.png"
        ...
        <article className="flex flex-col justify-between rounded-2xl bg-emerald-600 p-8 text-white">
        ...
        <article className="rounded-2xl border border-zinc-200 bg-white p-8">
          <ClockCounterClockwise size={32} weight="light" className="text-zinc-400" />
        ...
        <article className="md:col-span-2 overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-50">
          <div className="p-8">
            <h3 className="text-xl font-semibold text-zinc-950">
          ...
          <div className="ml-8 h-56 overflow-hidden rounded-tl-2xl border-l border-t border-zinc-200 bg-white">
            <Image
...
function Argent() {
  return (
    <section className="border-y border-zinc-200 bg-zinc-50 px-5 py-24">
        ...
        <div>
          ...
          <ul className="mt-8 space-y-3">
            {[
              ...
              <li key={ligne} className="flex items-start gap-3 text-zinc-700">
                <CheckCircle
                  size={20}
                  weight="fill"
...
function HorsLigne() {
  return (
    <section className="mx-auto max-w-5xl px-5 py-24 text-center">
      <WifiSlash size={40} weight="light" className="mx-auto text-emerald-600" />
      <h2 className="mt-6 text-3xl font-semibold tracking-tight text-zinc-950 md:text-4xl">
            ...
            >
              ...
              <p
                className={`mt-1 text-sm ${
                  offre.mis ? "text-zinc-500" : "text-zinc-400"
                }`}
              >
                {offre.pour}
              </p>
              <p className="mt-6 flex items-baseline gap-2">
                ...
                <span
                  className={offre.mis ? "text-zinc-500" : "text-zinc-400"}
                >
                  FCFA par mois
                </span>
              </p>
                ...
                {offre.avantages.map((avantage) => (
                  <li key={avantage} className="flex items-start gap-3 text-sm">
                    <CheckCircle
                      ...
                      className="mt-0.5 shrink-0 text-emerald-600"
                    />
                    <span className={offre.mis ? "text-zinc-700" : "text-zinc-300"}>
                      {avantage}
                    </span>
                  </li>
                ))}
              ...
              <Link
                href="/signup"
                className={`mt-8 block rounded-xl px-6 py-3.5 text-center text-base font-medium transition-transform active:translate-y-px ${
                  offre.mis
    ...
    <section className="mx-auto max-w-3xl px-5 py-24">
      ...
      <div className="mt-10">
        {questions.map((item) => (
          ...
          >
            <summary className="flex cursor-pointer items-center justify-between gap-4 text-base font-medium text-zinc-950">
              {item.q}
              <span className="shrink-0 text-zinc-400 transition-transform group-open:rotate-45">
                +
              </span>
            </summary>
            <p className="mt-3 leading-relaxed text-zinc-600">{item.r}</p>
          </details>
        ))}
      </div>
    </section>
...
function AppelFinal() {
  return (
    <section className="border-t border-zinc-200 bg-emerald-50 px-5 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-700/20 bg-white px-6 py-4 text-base font-medium text-zinc-900 transition-colors hover:bg-zinc-50 active:translate-y-px"
          >
            <WhatsappLogo size={18} weight="fill" />
            Poser une question
          </a>
  ...
  return (
    <footer className="bg-white px-5 py-12">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-sm text-zinc-500 sm:flex-row">
        <span className="font-semibold text-zinc-950">TailorHub</span>
